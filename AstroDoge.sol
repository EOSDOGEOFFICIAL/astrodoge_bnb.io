...
/**
    AstroDoge - all the other projects take you to the moon, but how can we leave behind men's best friend?! 
    AstroDoge aims to take BOTH you and your puppies to the moon!
    AstroDoge is a charity-oriented token aimed to help dog rescue groups rescuing dogs from abuse, neglect, or injuries–off the streets.
    
    AstroDoge awards the community when we reach 600 holders.
...
contract AstroDoge is Context, IERC20, Ownable {
    ...
    string private _name = "AstroDoge";
    string private _symbol = "AstroDoge";
